...
function init() {
    ...
    */
    ...
    adeymo.pulse.position.x = -100;
    adeymo.pulse.position.y = -70;
    ...
    */
    ...
    gui.add( particle_options, "lifetime", .1, 1 ).listen();
    gui.add( particle_options, "positionRandomness", 0, 5000).listen();
    /* END PARTICLE SYSTEM
    */
...
function render( time ){
    ...
    var range = knob.svn.value;
    range = knob.svn.value*5000;
    particle_options.positionRandomness = ease(range, particle_options.positionRandomness, .1);
